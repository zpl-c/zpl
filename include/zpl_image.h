...
extern "C" {
    ...
    ZPL_DEF zpl_gif_result_t *zpl_image_gif_load(char const *filename, i32 *x, i32 *y, i32 *frames);
    ZPL_DEF void          zpl_image_gif_free(zpl_gif_result_t *gif, b32 aligned);
#endif
