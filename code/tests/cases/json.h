...
MODULE(json5_parser, {
    ...
    IT("writes a complex JSON5 document", {
        ...
        o = zpl_json_inset(&doc, "$api", "opengl");
        o = zpl_json_inset(&doc, "name", "Diffuse shader");
        o = zpl_json_inset(&doc, "version", 150);
        o = zpl_json_inset(&doc, "type", "fragment");
        o = zpl_json_inset_arr(&doc, "uniforms");
        {
            o2 = zpl_json_inset_obj(o, NULL);
            {
                zpl_json_inset(o2, "name", "l_pos");
                zpl_json_inset(o2, "type", "vec3");
            }
            o2 = zpl_json_inset_obj(o, NULL);
            {
                zpl_json_inset(o2, "name", "l_mat");
                zpl_json_inset(o2, "type", "mat4");
            }
        }
        o = zpl_json_inset(&doc, "_meta", "0 0 -34 2.34 123 2.34e-4");
